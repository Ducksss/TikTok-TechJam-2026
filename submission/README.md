...
**FeatDistill** four-expert detector and the installable `featdistill-infer`
...
lineage. This hosted experience is an explanatory submission demo, not an
interactive browser inference upload form. Executable local inference is

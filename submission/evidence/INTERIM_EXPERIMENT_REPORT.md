# FeatDistill inference-only experiment report
...
the released FeatDistill four-expert probability mean with its decision
...
|---|---|---|
| Checkpoints | Four released FeatDistill experts | Unchanged |

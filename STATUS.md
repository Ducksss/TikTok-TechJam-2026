...
| Brand-assets worktree | `codex/synthflag-brand-assets` | **Clean:** attached to the named branch and synchronized with its upstream | `Assets` — **active** | **Running** | SynthFlag core identity, digital/social, print/event, and evidence-system asset batches are being generated. Select and verify the final small public set; do not publish the full historical FeatDistill exploration dump by default. |

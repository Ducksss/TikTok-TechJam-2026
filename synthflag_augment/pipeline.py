...
def robustness_recipe(*, seed: str | int = 0) -> AugmentationPipeline:
    ...
    The preset is an experiment utility, not a reconstruction of the
    paper-described training policy. Protected final-evaluation rows must not
    be used to tune this recipe or any model trained with it.
    """

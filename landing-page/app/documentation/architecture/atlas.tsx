...
type AtlasSection = {
  ...
  height?: number;
  id: (typeof atlasContents)[number][0];
  kicker: string;
  lead: ReactNode;
  number: string;
  technical: ReactNode;
...
const sections: AtlasSection[] = [
  ...
  },
  {
    ...
    alt: 'Video analysis contract showing a short video remaining in the browser while eight midpoint frames are center-cropped into lossless PNG files, posted directly or through the edge proxy, scored in two-frame microbatches by unchanged SynthFlag inference, and summarized without audio, motion, provenance, or video-probability claims.',
  ...
  },
  {
    ...
    alt: 'Boundary diagram separating paper-described training, externally supplied fine-tuned checkpoints, the public SynthFlag source and evidence release, and optional fixed-weight inference deployment.',
      ...
      >
        ...
        <div className="atlas-overview-grid">
          ...
          <div>
            <span>Layer 02</span>
            <h3>Runtime</h3>
            <p>How the process loads weights and turns tensors into scores.</p>
          </div>
          <div>
            <span>Layer 03</span>
